...
const Hero = ({ darkTheme }) => {
    ...
    const theme = darkTheme ? darkMode : lightTheme;
                ...
                lg:mt-0 mt-14'>
                    ...
                    lg:items-start text-center lg:text-left mb-12 lg:mb-0'>
                        ...
                        <p className={`mb-6 sm:mb-8 leading-relaxed max-w-md
                            ...
                            data-aos='fade-up'
                            data-aos-delay='600'>
                            Hire me or give me gig to see my full potential!.
                        </p>
                        {/* button */}
                    ...
                    >
                        ...
                        <div className='relative overflow-hidden'>
                            ...
                            hover:scale-105 transition-transform-500' />

                        </div>
                        <img 
                        src={hi} 
                        alt="hi logo"
                        className='absolute top-5 sm:top-7 left-35
                        sm:left-80 w-14 sm:w-50 sm:h-50 object-contain
