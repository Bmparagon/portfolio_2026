...
const Navbar = ({ darkMode, toggleDarkMode }) => {
  ...
  const navItems = [
    ...
    { name: "skills", label: "Skills", link: "#skills" },
    { name: "projects", label: "Projects", link: "#projects" },
  ...
  return (
    <div className="fixed top-4 left-0 right-0 z-50 flex justify-center px-4">
      <motion.nav
        ...
        className={`pointer-events-auto flex items-center justify-center ${colors.navBg}
          backdrop-blur-lg rounded-2xl px-4 lg:px-8 shadow-lg max-w-6xl`}
      >
        <div
        ...
        {isMenuOpen && (
          ...
          ${darkMode
            ? 'bg-gray-900/95'
            : 'bg-white/95'
          } background-blur-lg rounded-xl shadow-lg border ${
